...
import 'package:prioritas1/screens/login.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          children: [
            const Text("Contact"), // Judul "Contact"
            const Spacer(
              flex: 6,
            ), // Spasi agar teks "Hello, [nama pengguna]" berada di tengah
            Text("Hello, $username"), // Teks "Hello, [nama pengguna]"
          ],
        ),
        actions: [
          ElevatedButton(
